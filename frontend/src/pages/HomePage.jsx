...
// Mappage des catégories en français
...
const HomePage = () => {
	...
	useEffect(() => {
		if (data?.categoryStatistics) {
			...
			const translatedCategories = categories.map(category => categoryTranslationMap[category]);
		...
		<>
			<div className='flex flex-col gap-6 items-center max-w-7xl mx-auto z-20 relative justify-center'>
				<div className='flex items-center'>
					...
					Suivez chaque centime, vivez sereinement
					</p>
					<img
