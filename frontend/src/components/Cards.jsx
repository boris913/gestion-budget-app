...
const Cards = () => {
	...
	return (
		<div className='w-full px-10 min-h-[40vh]'>
			<p className='text-5xl font-bold text-center my-10'>Historique</p>
			...
			{!loading && data?.transactions?.length === 0 && (
				<p className='text-2xl font-bold text-center w-full'>Aucun historique de transaction trouvé.</p>
			)}
		</div>
	);
};
